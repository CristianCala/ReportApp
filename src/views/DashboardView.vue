<template>
    <div class="relative overflow-x-auto-20 px-5 py-5">
        <div class="flex items-center justify-between mb-4">
            <div>
                <h2
                    class="text-2xl font-black leading-9 tracking-tight text-gray-900"
                >
                    Menú Reporte
                </h2>
                    ...
                    <div class="flex flex-wrap items-center">
                        ...
                        >
                            <button
                                ...
                                class="bg-emerald-500 text-white active:bg-emerald-600 text-xs font-bold px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1"
                                type="button"
                            >
                                Crear Reporte
                            </button>
                            ...
                            >
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="relative">
                                        ...
                                        <div
                                            v-if="showDropdown(report.id)"
                                            class="absolute z-10 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                                            role="menu"
...
export default {
    ...
    methods: {
        ...
        getRowClass() {
            const className =
                this.counter % 2 === 0 ? "bg-white" : "bg-gray-200";
            this.counter++;
            return className;
        },
    },
